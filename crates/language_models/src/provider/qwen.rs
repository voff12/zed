...
impl QwenLanguageModelProvider {
    ...
    fn create_language_model(&self, model: qwen::Model) -> Arc<dyn LanguageModel> {
...
impl LanguageModelProvider for QwenLanguageModelProvider {
    ...
    fn default_model(&self, _cx: &App) -> Option<Arc<dyn LanguageModel>> {
        Some(self.create_language_model(qwen::Model::default()))
    }

    fn default_fast_model(&self, _cx: &App) -> Option<Arc<dyn LanguageModel>> {
        Some(self.create_language_model(qwen::Model::default_fast()))
    }

    fn provided_models(&self, cx: &App) -> Vec<Arc<dyn LanguageModel>> {
        let mut models = collections::IndexMap::default();

        models.insert("qwen-turbo", qwen::Model::QwenTurbo);
        models.insert("qwen-plus", qwen::Model::QwenPlus);
        models.insert("qwen-max", qwen::Model::QwenMax);
        models.insert("qwen3-235b-a22b", qwen::Model::Qwen3235B);
        models.insert("qwen3-32b", qwen::Model::Qwen332B);
...
impl LanguageModel for QwenLanguageModel {
    ...
    fn stream_completion(
        ...
        >,
    > {
        let request = into_qwen(request, &self.model, self.max_output_tokens());
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use Qwen in Zed, you need a DashScope API key:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
