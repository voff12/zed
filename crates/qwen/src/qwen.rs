...
pub const QWEN_API_URL: &str = "https://dashscope.aliyuncs.com/compatible-mode/v1";
...
impl Model {
    ...
    pub fn from_id(id: &str) -> Result<Self> {
        match id {
            ...
            "qwen-max" => Ok(Self::QwenMax),
            "qwen3-235b-a22b" => Ok(Self::Qwen3235B),
            "qwen3-32b" => Ok(Self::Qwen332B),
    ...
    pub fn id(&self) -> &str {
        match self {
            ...
            Self::Qwen3235B => "qwen3-235b-a22b",
            Self::Qwen332B => "qwen3-32b",
    ...
    pub fn max_token_count(&self) -> u64 {
        match self {
            Self::QwenTurbo | Self::QwenPlus | Self::QwenMax => 1_000_000,
            Self::Qwen3235B | Self::Qwen332B => 131_072,
    ...
    pub fn max_output_tokens(&self) -> Option<u64> {
        match self {
            Self::QwenTurbo | Self::QwenPlus | Self::QwenMax => Some(8_192),
            Self::Qwen3235B | Self::Qwen332B => Some(16_384),
            Self::Custom {
                max_output_tokens, ..
            } => *max_output_tokens,
        }
